    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-indigo-500 selection:text-white relative overflow-x-hidden">
      ...
      <div className="relative z-10 p-4 md:p-6 h-auto lg:h-[calc(100vh-80px)] flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between shrink-0 gap-4">
          ...
          {/* Month Navigation */}
          <div className="flex items-center justify-between gap-4 bg-white/5 backdrop-blur-md border border-white/10 p-1.5 rounded-xl w-full md:w-auto">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col lg:flex-row gap-6 flex-1 min-h-0">
            ...
            {/* LEFT: Calendar Grid */}
            <div className="flex-1 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-3 md:p-6 flex flex-col shadow-2xl">
              {/* Weekday Headers */}
            ...
            <div ref={detailsRef} className="w-full lg:w-96 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 flex flex-col h-[500px] lg:h-full shadow-2xl shrink-0">
