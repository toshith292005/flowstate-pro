        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
               ...
               <button type="button" onClick={handleFeatureComingSoon} className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors font-medium p-1">Forgot password?</button>
            </div>
            <div className="relative group">
