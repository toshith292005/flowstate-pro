...
export default function Settings() {
  ...
  return (
    // OPTIMIZATION: Adjusted padding and margins for mobile
    <div className="p-4 md:p-10 max-w-4xl mx-auto pb-24 space-y-6 md:space-y-8 bg-black min-h-screen">
      ...
      {/* ACCOUNT & PHOTO */}
      <section className="bg-white/5 border border-white/10 rounded-3xl p-5 md:p-8 relative overflow-hidden transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 mb-2 relative z-10">
          <div className="relative group shrink-0">
            <div className="h-24 w-24 md:h-28 md:w-28 rounded-full bg-indigo-600 flex items-center justify-center text-white text-3xl font-bold border-4 border-black shadow-xl overflow-hidden relative">
            ...
            {isEditing && (
                <div className="absolute bottom-0 right-0 bg-indigo-600 p-2 rounded-full border-2 border-black text-white">
                    <Camera size={14} />
                </div>
            )}
          </div>
              ...
              <div className="space-y-4 w-full max-w-md mx-auto md:mx-0">
                  <div>
                    ...
                    <input 
                        ...
                        // OPTIMIZATION: text-base prevents zoom on mobile
                    ...
                    <div className="flex gap-2">
                        ...
                        {tempPhoto && (
                            <button 
                                ...
                                className="p-3 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 rounded-xl transition-colors active:scale-95 shrink-0"
                            >
                                <Trash2 size={20} />
                            </button>
                        )}
      ...
      {/* NOTIFICATIONS */}
      <section className="bg-white/5 border border-white/10 rounded-3xl p-5 md:p-8">
      ...
      {/* DANGER ZONE */}
      <section className="border border-red-500/20 bg-red-500/5 rounded-3xl p-5 md:p-8">
